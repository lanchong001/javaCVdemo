...
public class WebcamAndMicrophoneCapture {
	...
	public static void test1()
		...
		recordWebcamAndMicrophone(0, 4, "rtmp://192.168.1.192:1935/live/audio1", 1280, 720, 25);
	}

	/**
	 * 录制麦克风(音频)
	 * @param AUDIO_DEVICE_INDEX -本地音频混合器(即音频设备)
	 * @param outputFile - 输出文件/流媒体服务器地址
	 * @param FRAME_RATE -关键帧间隔
	 * @return
	 */
	...
	public static void test2() throws InterruptedException, LineUnavailableException {
		int FRAME_RATE = 25;
		ScheduledThreadPoolExecutor exec = new ScheduledThreadPoolExecutor(1);
		Runnable crabAudio = recordMicroPhone(4, "rtmp://192.168.1.192:1935/live/audio1",FRAME_RATE);
	 ...
	 * @param outputFile
	 */
	public static void recordMicroPhoneAndPlay(String inputFile, String outputFile){
		try {
			FFmpegFrameGrabber grabber=FFmpegFrameGrabber.createDefault(inputFile);
		} catch (org.bytedeco.javacv.FrameGrabber.Exception e) {
			System.out.println("打开音频源失败");
			return;
		}
